                            ...
                            match commit_result {
                                Ok(()) => {
                                    ...
                                    if !all_states_synced {
                                        ...
                                        if let Err(error) = metadata_storage.clone().update_last_persisted_state_value_index(version, last_committed_state_index, all_states_synced) {
                                    ...
                                    let commit_notification = create_commit_notification(&target_output_with_proof, last_committed_state_index, version);
                                    ...
                                    } else if let Err(error) = metadata_storage.clone().update_last_persisted_state_value_index(version, last_committed_state_index, all_states_synced) {
